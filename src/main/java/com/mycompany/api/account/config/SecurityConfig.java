 ...
 *   <li>Payment and validation endpoints — CSRF disabled, authenticated via API key</li>
 * </ul>
 *
        ...
        http
                ...
                .csrf(csrf -> csrf
                        ...
                        .requireCsrfProtectionMatcher(request -> {
                            ...
                            // Validation endpoints — authenticated via API key, not cookies
                            if (path.matches(".*/api/v1/accounts/\\d+/validate")
                                    || path.matches(".*/api/v1/customers/\\d+/validate")) {
                                return false;
                            }
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Provider validation endpoints — API key auth, not Spring Security
                        .requestMatchers("/api/v1/accounts/*/validate").permitAll()
                        .requestMatchers("/api/v1/customers/*/validate").permitAll()
